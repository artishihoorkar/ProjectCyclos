...
public class ChangeMemberPasswordCheckPOM {
	private WebDriver driver; 
	//constructor to initialize the driver
	public ChangeMemberPasswordCheckPOM(WebDriver driver) {
		this.driver = driver; 
	...
	//adding old password on change password page
	public void oldpassword(String oldpwd) {
		this.oldpwd.clear();
		this.oldpwd.sendKeys(oldpwd);
	}
	//adding new password on change password page
	public void newpassword(String newpwd) {
		this.newpwd.clear(); 
		this.newpwd.sendKeys(newpwd);
	}
	//confirm new password on change password page
